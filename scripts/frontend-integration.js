 ...
 * This file demonstrates how to integrate Gatehinge with a web frontend
 */

// For React/Vue/Angular applications
export class GatehingeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GatehingeClient(provider, contractAddress);
